...
общение | использование команд в торговой площадке. 
Наказания выдаются ПОСЛЕ того, как игрок
проигнорировал предупреждение
модератора об этом:
1. Соответствующим нотом ".оффтоп"
2. Устно
```
```Наказание:
...
```Что запрещено:
Намеренная остановка игр более 3 раз с целью препятствовать заработку аметистов
...
После → Чс бота
```
### Пункт 6. Нарушение порядка обращений, попрошайничество
```Что запрещено:
1. Просьбы к админам (тп, ресурсы и т.д.).
2. Писать администратору в личные сообщения с просьбой разбанить/размутить/снять наказание без указания причины*  
3. Жаловаться администратору в личные сообщения на других игроков*
4. Другие возможные нарушения порядка обращений, т.е. иным путём "мешать" модераторам выполнять свою работу

*Разрешается, если у вас ТГбан или нет возможности написать на Форум.
```
```Пример нарушения: 
...
```Что запрещено:
Открытая публикация 18+ контента без спойлера: обнажённые тела, кровь, насилие, порнографические материалы, смерт(-и) людей, нац. и фаш. символика, военные преступления
...
2-е → Временный / постоянный бан
3-е → Постоянный бан
4-е ОБХ → ЧСП, ЧС бота и глобальный бан
‼️ Дополнение:
* Дома/вещи и т.д. заблокированных ПЕРМАНЕНТНО МОЖНО присваивать себе.
** Возмещение возможно только при личном примирении сторон. Администратор ожидает решения не дольше двенадцати реальных часов с момента инцидента.
```
...
```Что запрещено:
Обманом выманивать аметисты у игроков
Осуществлять обман при обмене аметистов на реальные деньги
    и/или иную валюту и наоборот
Создавать любые другие схемы, приводящие к потере аметистов и/или аккаунта(-ов)
```
```Наказание:
...
```Наказание:
Автоматическое - бан 5 минут
1-e → Бан 1-7 суток
2-e → Бан 7-30 суток
3-e → Бан 7-60 суток
4-е → Перманентный бан
5-е ОБХ → ЧСП и глобан
```